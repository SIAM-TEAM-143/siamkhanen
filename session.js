// --- AMR TASK Security & Admin Control ---

(function() {
    const userId = localStorage.getItem('currentUserId');
    const path = window.location.pathname;
    const currentPage = path.split("/").pop();
    const publicPages = ['login.html', 'register.html', 'forget.html', 'index.html','review.html', ''];
        ...
        import("https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js").then(m => {
            ...
            import("https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js").then(f => {
                ...
                const firebaseConfig = {
                     apiKey: "AIzaSyDbyV4futjEJjdAbR3dMNf6dOIhAuj7tTo",
                     authDomain: "task-2503d.firebaseapp.com",
                     projectId: "task-2503d",
                     appId: "1:707479242322:web:492db72a3b86653a0d018b"
                 };
